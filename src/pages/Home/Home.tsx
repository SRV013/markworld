...
export function Home() {
  return (
    <div className={styles.page}>
      <Helmet>
        <title>
          Mark World — Estadísticas e Historia de los Mundiales de Fútbol
        </title>
        <meta
          name="description"
          content="Estadísticas, historia y pronósticos de todos los Mundiales de Fútbol desde 1930. Fixture 2026, campeones históricos, brackets y más."
        />
      ...
      <section className={styles.hero}>
        ...
        <p className={styles.heroSub}>
          Estadísticas, historia y pronósticos del fútbol mundial. Toda la Copa
      ...
      <section className={styles.sections}>
        {SECTIONS.map(({ to, icon, title, desc, promo }) => (
          <NavLink
            key={to}
            to={to}
            className={`${styles.card} ${promo ? styles.cardPromo : ""}`}
          >
